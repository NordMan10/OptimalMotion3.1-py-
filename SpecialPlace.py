...
class SpecialPlace(IMassServiceZone):
    ...
    def get_free_interval(self, new_interval):
        IMassServiceZoneExtensions.get_free_interval(self, new_interval, self._processing_intervals)

    def remove_aircraft_interval(self, aircraft_id):
        IMassServiceZoneExtensions.remove_aircraft_interval(self, aircraft_id, self._processing_intervals)

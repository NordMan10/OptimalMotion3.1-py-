...
class InputTakingOffMoments(object):
    ...
    def get_nearest_permitted_moment(self, possible_moment):
        for i in range(self._last_permitted_taking_off_moment_index, len(self._ordered_permitted_moments)):
            ...
            if permitted_moment - CommonInputData.spare_arrival_time_interval.get_start_moment() >= possible_moment:
    ...
    def get_unused_planned_moments(self):
        ...
        unused_planned_moments = unused_planned_moments[:self._last_planned_taking_off_moment_index + 1]
